"""Focal loss + inverse-frequency class weights.

Ported verbatim from research/lob/losses.py — the (1-p)^gamma factor
down-weights easy (mostly FLAT) examples so the model can't win by
always predicting flat.
"""
